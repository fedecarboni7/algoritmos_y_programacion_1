...
def merge_usuarios(ruta):
    errores = False
    try:
        lista_a_archivo(ruta, "usuarios_1.csv",
                        ordenar(ruta, "usuarios_1.csv"))
        usuarios_1 = open(f'{ruta}usuarios_1.csv', 'r')
        lista_a_archivo(ruta, "usuarios_2.csv",
                        ordenar(ruta, "usuarios_2.csv"))
        usuarios_2 = open(f'{ruta}usuarios_2.csv', 'r')
        lista_a_archivo(ruta, "usuarios_3.csv",
                        ordenar(ruta, "usuarios_3.csv"))
    ...
    id_usuario_1, nombre_apellido_1, año_de_nacimiento_1, lista_peliculas_1 = leer_info(
        usuarios_1)
    clave_usuario_1 = [id_usuario_1, nombre_apellido_1,
                       año_de_nacimiento_1, lista_peliculas_1]

    id_usuario_2, nombre_apellido_2, año_de_nacimiento_2, lista_peliculas_2 = leer_info(
        usuarios_2)
    clave_usuario_2 = [id_usuario_2, nombre_apellido_2,
                       año_de_nacimiento_2, lista_peliculas_2]

    id_usuario_3, nombre_apellido_3, año_de_nacimiento_3, lista_peliculas_3 = leer_info(
        usuarios_3)
    ...
    while id_usuario_1 != max or id_usuario_2 != max or id_usuario_3 != max:
        ...
        while men[0] == clave_anterior[0]:
            ...
            if men == clave_usuario_1:
                clave_usuario_1 = id_usuario_1, nombre_apellido_1, año_de_nacimiento_1, lista_peliculas_1 = leer_info(
                    usuarios_1)
            elif men == clave_usuario_2:
                clave_usuario_2 = id_usuario_2, nombre_apellido_2, año_de_nacimiento_2, lista_peliculas_2 = leer_info(
                    usuarios_2)
            elif men == clave_usuario_3:
                clave_usuario_3 = id_usuario_3, nombre_apellido_3, año_de_nacimiento_3, lista_peliculas_3 = leer_info(
                    usuarios_3)
...
def ordenar(ruta, archivo):
    with open(f'{ruta}{archivo}', 'r+') as usuarios_ordenado:
        ...
        id_usuario, nombre_apellido, año_de_nacimiento, lista_peliculas = leer_info(
            usuarios_ordenado)
    ...
    with open(f'{ruta}peliculas.txt', 'ab') as archivo_peliculas:
        ...
        while seguir == "s":
            ...
            while 1 > puntaje or puntaje > 9:
                puntaje = int(
                    input("Por favor ingrese un número del 1 al 9: "))
...
def baja_de_pelicula(ruta):
    with open(f'{ruta}peliculas.txt', 'r+b') as archivo_peliculas:
        ...
        if baja_exitosa:
            lista_a_archivo_bin(ruta, "peliculas.txt", lista_peliculas)
