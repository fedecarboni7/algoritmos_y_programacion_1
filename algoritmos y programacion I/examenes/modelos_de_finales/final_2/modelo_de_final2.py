...
o Calcular y dejar en un archivo CSV de nombre Saldos, la suma total del saldo de
...
def merge_in_dict():
    ...
    caja_ahorros = open(r"C:\Users\feden\Documents\Programación\repositorios git\fiuba\algoritmos y programacion I\examenes\modelos_de_finales\final_2\caja_ahorros.csv","r")
    ctas_corriente = open(r"C:\Users\feden\Documents\Programación\repositorios git\fiuba\algoritmos y programacion I\examenes\modelos_de_finales\final_2\ctas_corriente.csv","r")
    acciones = open(r"C:\Users\feden\Documents\Programación\repositorios git\fiuba\algoritmos y programacion I\examenes\modelos_de_finales\final_2\acciones.csv","r")
    fondos_de_inversion = open(r"C:\Users\feden\Documents\Programación\repositorios git\fiuba\algoritmos y programacion I\examenes\modelos_de_finales\final_2\fondos_de_inversion.csv","r")
...
def dict_to_archive(dicc_cuil_saldo):
    archivo_saldos = open(r"C:\Users\feden\Documents\Programación\repositorios git\fiuba\algoritmos y programacion I\examenes\modelos_de_finales\final_2\saldos.csv","w")
